        	...
        	if(data.data){
				...
				listLength = data.total_count;
  	    	    $.each(json,function(i,item){
  	             ...
  	             $("#productList").append(" <div  class='productContainer' onclick='jumpProduct(\""+product_code+"\")'><div class='productTitle'>" + product_name+"</div><div ><div class='nianhua'><div class='txt1'>"
...
function jumpAuthorization(pId){
    window.location.href = '/view/externalDocking/authorization.html'+'?target=product_detail&product_code='+pId;
}
...
//            window.location.href ='http://tjsappp.tjfae.com/fxh5/index.html?'+data.url+str;
    		    window.location.href =superUrl + 'fxh5/index.html?'+data.url+str;
        	}else{        		
				layer.open({
